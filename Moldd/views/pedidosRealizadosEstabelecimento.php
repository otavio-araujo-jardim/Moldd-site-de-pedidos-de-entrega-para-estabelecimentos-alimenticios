...
<head>
	...
	<link rel="stylesheet" href="views/css/pedidosRealizadosEstabelecimento.css">
				...
				<div class="col-xs-12 col-md-8">
					<section class="pedido__dados">
						...
						<section class="clearfix">
							...
							<div class="col-xs-12 col-md-6">
								<?php echo '<button type="button" data-toggle="modal" data-target="#id-finalizar'.$infoPedido[0]->getId().'" class="botao botao--vermelho">
									Finalizar Pedido
								</button>'?>							
							</div>
							...
							<div class="finalizar">
								<?php echo '<div class="modal fade" id="id-finalizar'.$infoPedido[0]->getId().'">'?>
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" data-dismiss="modal" class="close finalizar__botao-fechar">
													<span>&times;</span>
												</button>
												<h3 class="modal-title finalizar__titulo">Finalizar Pedido</h3>
											</div>

											<div class="modal-body">
												Tem certeza que deseja finalizar o pedido de <span class="finalizar__nome"><?php echo $infoPedido[1] ?></span> ?
											</div>

											<div class="modal-footer">
												<div class="row">
													<div class="col-xs-12 col-sm-6">
														<button type="button" data-dismiss="modal" class="botao botao--amarelo finalizar__botao"> Cancelar </button>
													</div>

													<div class="col-xs-12 col-sm-6">
														<?php echo'<a href="?controle=pedido&acao=finalizar&id='. $infoPedido[0]->getId() .'" class="botao botao--vermelho finalizar__botao"> Finalizar </a>'; ?>
													</div>											
												</div>
											</div>
										</div>
			...
			echo '<div class="row alerta">
						<div class="col-xs-12 col-md-offset-3 col-sm-6">
							<div class="alert alert-danger">
								...
								&nbsp&nbsp Não há pedidos para este estabelecimento
							</div>
						</div>
					</div>';
		}
